  ...
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center p-4 z-10">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
        ...
        <div className="md:col-span-7 glass-panel-crimson p-8 rounded-2xl border border-slate-700/50 shadow-2xl relative">
          
          <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
            <div>
              <h1 className="text-2xl font-creepster text-3xl font-extrabold text-white tracking-wide flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs font-mono text-red-400 hover:text-red-300 underline underline-offset-4 cursor-pointer"
            >
